...
data = pd.read_csv('youtube_example.csv') ##Use the plot/export tool and export your openrocket data to a csv. Then make sure to change the first line to match the data[] keys in this script
...
velx0 = 0.0
velz0 = 0.0
mass0 = 0.594 #kg - you get this from the rocket design tab in openrocket
T1 = 189.0/1000.0 #Newtons converted to kN - double click your motor in Motor and Configurations and grab the average thrust
massflowrate = (80./1000.)/0.938 #Take the difference betweeen the initial motor mass in g and final motor mass in grams, divide by 1000 to get to kg and then divide by the burn time
exit_velocity = T1*1000 / massflowrate
Isp = exit_velocity / 9.81
print('Isp = ',Isp)
Cd = 0.59 #open your spreadsheet and grab the average of your drag coefficient over the length of the burn time
Cd_parachute = 0.8 #double click the parachute and grab the Cd of the parachute from the properties
t_parachute = 14.0-0.938 #GO back to your motor properties and check your ejection delay. This t_parachute is your ejection delay + your burn time
D = 5.0/100. #Double click your body tube and then check for your outer diameter in cm and divide by 100 to get to meters
S = D**2
S_parachute = ((50.0)/100.0)**2 ##This is the area of the parachute so I double click the parachute and look at the diamter
stage_1_time = 0.938 ##This is your single stage burn time which is also in your motor properties
stage_2_start = -99 ##YOu have a single stage rocket so leave the next
stage_2_end = -99 #two lines here at -99
period = 150.0 ##This is the time it takes for my rocket to ascend and descend.
